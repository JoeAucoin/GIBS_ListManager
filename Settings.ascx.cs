...
namespace GIBS.Modules.GIBS_ListManager
{
    ...
    /// 
    /// Because the control inherits from GIBS_ListManagerSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : GIBS_ListManagerModuleSettingsBase
    {
